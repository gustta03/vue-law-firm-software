...
import { makeRemoteSaveCustomer } from "../main/factories/usecases/customer/save-customer-factory";
import { makeRemoteSignupAttorney } from "../main/factories/usecases/attorney/signup-attorney-factory";
...
export const dependencies = {
  ...
  signup: makeRemoteSignupAttorney()
};